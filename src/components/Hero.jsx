  ...
  return (
    <section className={`flex md:flex-row flex-col ${styles.paddingY}`} id="home">
      ...
      <h1 className=' font-poppins font-semibold ss:text-[68px]
          ...
          <p className={`${styles.paragraph} max-w-[470p] mt-5`}>our team of experts uses a methodology to identify the credit caards most likely
            fit your needs. we examine anuual precentage rates ,annual fees.
          </p>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        {/* to add gradient effect behind the image  */}
